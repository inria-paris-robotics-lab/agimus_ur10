...
def launch_setup(context):
    ...
    #Config file
    moveit_config = (
        MoveItConfigsBuilder(robot_name="mantis", package_name="prl_ur10e_moveit")
        .robot_description_semantic(Path("config") / "ur10e.srdf")
        .to_moveit_configs()
    )
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("prl_ur10e_moveit"), "config", "moveit.rviz"]
    )
