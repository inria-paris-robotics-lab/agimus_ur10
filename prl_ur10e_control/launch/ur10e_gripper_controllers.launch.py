...
# Usage:
#   - ros2 launch prl_ur10e_control ur10e_gripper_controllers.launch.py gripper_controller:=<gripper-type> prefix:=<tf-prefix>
############################################################################################################
...
def launch_setup(context):
    ...
    if controller == "weiss-gripper":
        weiss_controller = IncludeLaunchDescription(
            ...
            launch_arguments=[
                ('prefix', prefix),('controller_file', PathJoinSubstitution([FindPackageShare('prl_ur10e_control'), 'config', 'wsg50_integrate.yaml']))
            ],
        )
        ...
        onrobot_controller = IncludeLaunchDescription(
            ...
            launch_arguments=[
                ('prefix', prefix),
                ('controller_file', PathJoinSubstitution([FindPackageShare('prl_ur10e_control'), 'config', 'onrobot_rg.yaml']))
            ],
        )
